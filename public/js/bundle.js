...
var HomeActions = (function () {
  function HomeActions() {
    ...
    this.generateActions('getTwoCharactersSuccess', 'needToAdd', 'getTwoCharactersFail', 'voteFail');
  }
  ...
  _createClass(HomeActions, [{
    ...
    value: function getTwoCharacters() {
      ...
      $.ajax({ url: '/api/characters' }).done(function (data) {
        ...
        if (jqXhr.status === 409) {
          _this.actions.needToAdd(jqXhr.responseJSON.message);
        } else {
...
var AddCharacter = (function (_React$Component) {
  ...
  _createClass(AddCharacter, [{
    ...
    value: function componentWillUnmount() {
      console.log("addCharacter will unmount!!!");
...
var Character = (function (_React$Component) {
	...
	_createClass(Character, [{
		...
		value: function componentDidUpdate(prevProps) {
			//id�仯����������δumount����id�仯��������state�仯��ʱ�򣬻����»�ȡ��id��ɫ��Ϣ
		...
		value: function render() {
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					...
					_react2['default'].createElement(
						'a',
						{ className: 'magnific-popup', href: '/img/character.jpg' },
						_react2['default'].createElement('img', { src: '/img/character.jpg' })
					)
				),
				_react2['default'].createElement(
					'div',
...
var Footer = (function (_React$Component) {
  ...
  _createClass(Footer, [{
    ...
    key: 'render',
    value: function render() {
      console.log("-----" + this.state.characters[0] + "  " + this.state.characters[1] + "  " + this.state.characters[2] + "  " + this.state.characters[3] + "  " + typeof this.state.characters);
      ...
      var characterNodes = this.state.characters.map(function (character, index) {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement('img', { onClick: _this.handleClick.bind(_this, character), src: '/img/caldari_bg.jpg' }),
            _react2['default'].createElement(
              'div',
...
var CharacterStore = (function () {
	...
	_createClass(CharacterStore, [{
		...
		value: function onGetCharacterSuccess(data) {
			...
			this.isReported = (0, _lodash.includes)(reports, this.characterId);
...
},{"../actions/CharacterActions":2,"../alt":6,"lodash":20}],17:[function(require,module,exports){
'use strict';
...
var HomeStore = (function () {
  ...
  _createClass(HomeStore, [{
    ...
    key: 'onNeedToAdd',
    value: function onNeedToAdd(data) {
      this.title = data;
    }
  }, {
    key: 'onVoteFail',
